...
export const AddHotelModel = observer(() => {
                ...
                >
                    ...
                    <div className='p-6 grid grid-cols-2 gap-5'>
                        ...
                        <ModalInput
                            ...
                            inputPlaceholder={TourStore.newTour.period_start}
                            inputType={'date'}
                            isRequired={true}
                        ...
                        <ModalInput
                            ...
                            inputPlaceholder={TourStore.newTour.period_end}
                            inputType={'date'}
                            isRequired={true}
